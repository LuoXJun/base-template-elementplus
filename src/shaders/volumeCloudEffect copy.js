// Auto-generated from volumeCloudEffect copy.glsl
// Hash: e474b7ae
// Generated at: 罗君

const VOLUMECLOUDEFFECT COPY_SOURCE = `
...
// Uniform 信息
export const VOLUMECLOUDEFFECT COPY_UNIFORMS = [
  {
    "type": "sampler2D",
    "name": "iChannel2"
  },
...
// Attribute 信息
export const VOLUMECLOUDEFFECT COPY_ATTRIBUTES = [];

// Shader 类
export class VolumeCloudEffect copyShader {
  constructor() {
    this.source = VOLUMECLOUDEFFECT COPY_SOURCE;
    this.uniforms = VOLUMECLOUDEFFECT COPY_UNIFORMS;
    this.attributes = VOLUMECLOUDEFFECT COPY_ATTRIBUTES;
    this.hash = 'e474b7ae';
  }
...
export default VOLUMECLOUDEFFECT COPY_SOURCE;