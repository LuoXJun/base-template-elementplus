// Auto-generated from ray_marching_intersect.glsl
// Hash: f7e724b2
// Generated at: 罗君

const RAY_MARCHING_INTERSECT_SOURCE = `
...
// Uniform 信息
export const RAY_MARCHING_INTERSECT_UNIFORMS = [];

// Attribute 信息
export const RAY_MARCHING_INTERSECT_ATTRIBUTES = [];

// Shader 类
export class RayMarchingIntersectShader {
  constructor() {
    this.source = RAY_MARCHING_INTERSECT_SOURCE;
    this.uniforms = RAY_MARCHING_INTERSECT_UNIFORMS;
    this.attributes = RAY_MARCHING_INTERSECT_ATTRIBUTES;
    this.hash = 'f7e724b2';
  }
...
export default RAY_MARCHING_INTERSECT_SOURCE;