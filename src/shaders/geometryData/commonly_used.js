// Auto-generated from commonly_used.glsl
// Hash: 7369108a
// Generated at: 罗君

const COMMONLY_USED_SOURCE = `
...
// Uniform 信息
export const COMMONLY_USED_UNIFORMS = [
  {
    "type": "sampler2D",
    "name": "iChannel2"
  }
...
// Attribute 信息
export const COMMONLY_USED_ATTRIBUTES = [];

// Shader 类
export class CommonlyUsedShader {
  constructor() {
    this.source = COMMONLY_USED_SOURCE;
    this.uniforms = COMMONLY_USED_UNIFORMS;
    this.attributes = COMMONLY_USED_ATTRIBUTES;
    this.hash = '7369108a';
  }
...
export default COMMONLY_USED_SOURCE;