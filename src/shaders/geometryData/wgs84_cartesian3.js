...
// Uniform 信息
export const WGS84_CARTESIAN3_UNIFORMS = [];

// Attribute 信息
export const WGS84_CARTESIAN3_ATTRIBUTES = [];

// Shader 类
export class Wgs84Cartesian3Shader {
  constructor() {
...
export default WGS84_CARTESIAN3_SOURCE;