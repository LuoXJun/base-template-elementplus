// Auto-generated from waterVS.glsl
// Hash: 20b6561b
// Generated at: 罗君

const WATERVS_SOURCE = `
in vec4 position;
in vec2 st;
out vec2 v_st;
...
// Uniform 信息
export const WATERVS_UNIFORMS = [];

// Attribute 信息
export const WATERVS_ATTRIBUTES = [];

// Shader 类
export class WaterVSShader {
  constructor() {
    this.source = WATERVS_SOURCE;
    this.uniforms = WATERVS_UNIFORMS;
    this.attributes = WATERVS_ATTRIBUTES;
    this.hash = '20b6561b';
  }
