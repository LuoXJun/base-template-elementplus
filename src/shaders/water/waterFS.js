// Auto-generated from waterFS.glsl
// Hash: cb2d2e7b
// Generated at: 罗君

const WATERFS_SOURCE = `
in vec2 v_st;
...
// Uniform 信息
export const WATERFS_UNIFORMS = [];

// Attribute 信息
export const WATERFS_ATTRIBUTES = [];

// Shader 类
export class WaterFSShader {
  constructor() {
    this.source = WATERFS_SOURCE;
    this.uniforms = WATERFS_UNIFORMS;
    this.attributes = WATERFS_ATTRIBUTES;
    this.hash = 'cb2d2e7b';
  }
