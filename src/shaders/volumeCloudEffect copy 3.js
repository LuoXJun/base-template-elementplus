// Auto-generated from volumeCloudEffect copy 3.glsl
// Hash: 74d24462
// Generated at: 罗君

const VOLUMECLOUDEFFECT COPY 3_SOURCE = `
...
// Uniform 信息
export const VOLUMECLOUDEFFECT COPY 3_UNIFORMS = [
  {
    "type": "sampler2D",
    "name": "iChannel2"
  },
...
// Attribute 信息
export const VOLUMECLOUDEFFECT COPY 3_ATTRIBUTES = [];

// Shader 类
export class VolumeCloudEffect copy 3Shader {
  constructor() {
    this.source = VOLUMECLOUDEFFECT COPY 3_SOURCE;
    this.uniforms = VOLUMECLOUDEFFECT COPY 3_UNIFORMS;
    this.attributes = VOLUMECLOUDEFFECT COPY 3_ATTRIBUTES;
    this.hash = '74d24462';
  }
...
export default VOLUMECLOUDEFFECT COPY 3_SOURCE;