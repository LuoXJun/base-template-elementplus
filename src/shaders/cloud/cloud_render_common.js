// Auto-generated from cloud_render_common.glsl
// Hash: 13ddd40b
// Generated at: 罗君

const CLOUD_RENDER_COMMON_SOURCE = `
...
// Uniform 信息
export const CLOUD_RENDER_COMMON_UNIFORMS = [];

// Attribute 信息
export const CLOUD_RENDER_COMMON_ATTRIBUTES = [];

// Shader 类
export class CloudRenderCommonShader {
  constructor() {
    this.source = CLOUD_RENDER_COMMON_SOURCE;
    this.uniforms = CLOUD_RENDER_COMMON_UNIFORMS;
    this.attributes = CLOUD_RENDER_COMMON_ATTRIBUTES;
    this.hash = '13ddd40b';
  }
...
export default CLOUD_RENDER_COMMON_SOURCE;