// Auto-generated from cloud_noise_common.glsl
// Hash: 06956f0f
// Generated at: 罗君

const CLOUD_NOISE_COMMON_SOURCE = `
...
// Uniform 信息
export const CLOUD_NOISE_COMMON_UNIFORMS = [];

// Attribute 信息
export const CLOUD_NOISE_COMMON_ATTRIBUTES = [];

// Shader 类
export class CloudNoiseCommonShader {
  constructor() {
    this.source = CLOUD_NOISE_COMMON_SOURCE;
    this.uniforms = CLOUD_NOISE_COMMON_UNIFORMS;
    this.attributes = CLOUD_NOISE_COMMON_ATTRIBUTES;
    this.hash = '06956f0f';
  }
...
export default CLOUD_NOISE_COMMON_SOURCE;